...
handleForm=(event)=>{
            ...
            fetch("https://api.openweathermap.org/data/2.5/weather?q="+city+"&units=metric&appid=590d1d148a8ebee34d9415b944e7a274")
                .then(response => response.json())
                .then(data => {
                    this.setState({iconID:data.weather[0].icon,
                                    name:data.name,
